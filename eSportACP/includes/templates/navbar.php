                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.php">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <p class="lead"><?php echo $websiteName; ?> <strong>Admin-CP</strong></p>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">إعدادات الموقع </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="sectionsShow.php" class="sidebar-link"><i class="mdi mdi-all-inclusive"></i><span class="hide-menu"> أقسام الموقع </span></a></li>
                                <li class="sidebar-item"><a href="generalSettings.php" class="sidebar-link"><i class="mdi mdi-all-inclusive"></i><span class="hide-menu"> إعدادات عامة </span></a></li>
                            </ul>
                        </li>
