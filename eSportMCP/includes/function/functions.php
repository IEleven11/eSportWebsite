<?php 
    ...
    */
    ...
    function pendingMembers() {
        ...
        if ($_SESSION['specialty'] != "designer" && $_SESSION['specialty'] != "editor") {
            ...
            $stmt = $con->prepare("SELECT * FROM `users` JOIN `" . $_SESSION['specialty'] . "` ON `" . $_SESSION['specialty'] . "`.userid = `users`.id WHERE `role` = 'pending'");
