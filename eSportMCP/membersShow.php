...
<?php
    ...
    if ($role['role'] != "administration" && $role['role'] != "manager") {
                                        ...
                                        <?php
                                            foreach($rows as $row) {
                                                ...
                                                echo '<tr>';
                                                    ...
                                                    if ($row['role'] != "administration" && $row['role'] != "manager" && $row['specialty'] == $_SESSION['specialty'] && $row['platform'] == $_SESSION['platform'] && $row['sex'] == $_SESSION['sex']) {
                                                        ...
                                                        if ($row['role'] != "administration" && $row['role'] != "manager") {
