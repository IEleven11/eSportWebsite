...
<?php
    ...
    if(isset($_GET['do']) && isset($_GET['tid'])) {
        ...
        if ($_GET['do'] == "delete") {
            ...
            $stmt = $con->prepare("DELETE FROM `tickets` WHERE `tickets`.`ticketid` = ?");
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach($rows as $row) {
                                                ...
                                                echo '<tr>';
                                                    echo '<td>' . $row['ticketname'] . '<strong>الإسم:</strong></td>';
                                                    echo '<td>' . $row['ticketemail'] . '<strong>البريد الإلكتروني:</strong></td>';
