                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.php">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <p class="lead"><?php echo $websiteName; ?> <strong>Support-CP</strong></p>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="newsShow.php" aria-expanded="false"><i class="mdi mdi-newspaper"></i><span class="hide-menu"> عرض الأخبار </span></a></li>
